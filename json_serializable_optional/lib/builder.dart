...
library optional_json_builder_builder;

import 'package:build/build.dart';
import 'package:json_annotation/json_annotation.dart';
import 'package:json_serializable/json_serializable.dart';
import 'package:json_serializable_optional/src/optional_type_helpers.dart';
...
Builder jsonSerializable(BuilderOptions options) {
  try {
    ...
    final lines = <String>['Could not parse the options provided for `json_serializable_optional`.'];
